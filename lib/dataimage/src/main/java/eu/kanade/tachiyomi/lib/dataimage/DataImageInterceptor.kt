 ...
 */
fun Element.dataImageAsUrlOrNull(attr: String): String? = if (attr(attr).startsWith("data")) {
 ...
 */
fun Element.dataImageAsUrl(attr: String): String = dataImageAsUrlOrNull(attr) ?: attr("abs:$attr")
