...
def interactive_wizard() -> dict:
    ...
    arch_choice = input("Select Architecture [1-4, default 1]: ").strip()
...
def main():
    ...
    parser.add_argument("--siteType", choices=["html", "api", "theme", "movie-locker"], default="html", help="Source architecture (html, api, theme, movie-locker)")
